<template>
  ...
  <div class="t-2column">
    <div class="t-2column__inner">
      ...
      <!------------------------------ 【End】2-Colmn-Layout--Main ------------------------------>
      <!------------------------------ 【Start】2-Colmn-Layout--Side ------------------------------>
      <div class="t-2column__side">
        <div class="t-2column__side-inner">
          <div class="o-card-list-box">
            <div class="o-card-list o-card-list--row o-card-list--square green">
