  ...
  <div class="t-contents t-ranking">
    ...
    <div class="t-2column">
      <div class="t-2column__inner">
        <div class="t-2column__main t-contents__inner">
          <ul class="a-tab">
...
export default {
  ...
  mounted: function() {
    global.$("body").addClass("p-ranking-vote");
  },
  destroyed: function() {
    global.$("body").removeClass("p-ranking-vote");
  },
  methods: {
      ...
      axios
        ...
        .then(
          axios.spread((api1Result, api2Result, api3Result) => {
            this.ranking_vote = api1Result.data.articles;
