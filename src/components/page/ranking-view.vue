      ...
      <div class="t-2column__inner">
        <div class="t-contents__inner t-2column__main">
          <div class="t-contents__inner__block">
            <ul class="a-tab">
              <li class="a-tab__item a-tab__item--on">
                <a href>
                  <router-link to="/ranking-view">閲覧数</router-link>
                </a>
              </li>
              <li class="a-tab__item">
                <a href>
                  <router-link to="/ranking-vote">回答数</router-link>
                </a>
              </li>
            </ul>
              ...
              <ul class="list">
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number m-card__image-number--top3">
                  ...
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">4</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
                ...
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">5</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
                ...
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">6</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
                ...
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">7</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
                ...
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">8</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
                ...
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">9</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
                ...
                <li class="item">
                  <div class="m-card m-card--row">
                    <div class="m-card__image">
                      <div class="m-card__image-number">
                        <div class="m-card__image-number-inner">10</div>
                      </div>
                      <div class="m-card__image-inner">
                        <a href>
                          <img src="@/images/thumbnail/dummy-thumbnail16_9.png" alt>
            ...
            <router-link to="/ranking-vote">
              <a href class="a-btn a-btn--large a-btn--more a-btn--green-arrow">回答数ランキングを見る
                <div class="arrow">
                  <!-- <?xml version="1.0" encoding="UTF-8"?> -->
                  <svg
                    width="17px"
